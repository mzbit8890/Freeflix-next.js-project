...
import { addTwoWatchList, deleteFromWatchList } from "../action";
...
export function MovieCard({
    ...
    <PlayVideoModel youtubeUrl={youtubeUrl} key={movieId} title={title} overview={overview} state={open} 
    changeState={setOpen} age={age} duration={time} release={year} />
    </>
    )
